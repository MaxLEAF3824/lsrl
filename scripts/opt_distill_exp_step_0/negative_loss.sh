...
DATA_FILE="/workspace/yiqiuguo/lsrl/gen_results/qwen3-1.7b-base_dapo_math_14k_en_openinstruct_rollout32_run20260417_ecb0.jsonl"
...
torchrun --nproc_per_node=4 /workspace/yiqiuguo/lsrl/latent_optimizer_v7.py \
    --model_name "$MODEL" \
    --file_path "$DATA_FILE" \
    --run_name latopt-distill-exp-dapo-step0-$(basename "$0" .sh) \
    --vllm_gpus 0 1 2 3 \
    --big_batch_size 1024 \
    --batch_size 1 \
    --chunk_size 1024 \
